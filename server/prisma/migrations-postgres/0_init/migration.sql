...
CREATE TABLE "Video" (
    ...
    "music" TEXT NOT NULL DEFAULT '鍘熷垱',
...
CREATE TABLE "Collect" (
    ...
    CONSTRAINT "Collect_pkey" PRIMARY KEY ("userId","videoId")
);
...
-- AddForeignKey
ALTER TABLE "Collect" ADD CONSTRAINT "Collect_videoId_fkey" FOREIGN KEY ("videoId") REFERENCES "Video"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
